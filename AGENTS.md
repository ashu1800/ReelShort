...
[2026-06-28] android-app/player-progress - 设计 Android Media3 播放进度同步，规划播放器位置轮询、秒级转换 helper 和现有观看上报边界接线。
