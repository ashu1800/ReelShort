...
- `android-app/release`：通过 GitHub Releases 检测稳定版，在 App 私有缓存流式下载 APK 并显示进度，经 SHA-256、包名、版本和签名校验后调用 Android 系统安装器；GitHub Actions 使用仓库 Secrets 中的正式签名材料构建并发布稳定 APK 与摘要资产。
