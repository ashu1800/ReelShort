...
[2026-06-28] android-app/api-diagnostics - 设计 App 本地 API 连接诊断，规划健康检查 URL 推导、OkHttp 未鉴权探测和账户页诊断面板。
