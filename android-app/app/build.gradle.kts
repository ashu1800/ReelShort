...
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.4.0").get()
val appVersionCode = providers.gradleProperty("appVersionCode").orElse("4").get().toInt()
